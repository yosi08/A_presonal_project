      ...
      days.push(
        <div
          ...
          className={`h-12 sm:h-24 border border-gray-100 dark:border-gray-700 p-1 sm:p-2 cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50 ${
            isSelected(day) ? 'bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800' : ''
          }`}
        >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
      ...
      <div className="bg-[#2563EB] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-white/80 mt-1">{t('manageSchedule')}</p>
        </div>
      </div>
              ...
              {selectedDateSessions.length === 0 ? (
                ...
                <div className="space-y-3">
                  {selectedDateSessions.map((session) => (
                    <div
                      key={session.id}
                      className="p-3 rounded-lg border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-800 transition-colors"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="p-1.5 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950 rounded transition-colors"
                          >
