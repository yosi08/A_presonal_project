        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-white/80 mt-1">{t('cornellNoteDescription') || '코넬 노트 방식으로 효율적인 학습을 하세요'}</p>
            </div>
            <button
              onClick={() => {
                setEditingNote(null)
              ...
              className="inline-flex items-center gap-2 bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors font-medium shadow"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredNotes.map((note) => (
              <div
                ...
                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-800"
              >
                <div className="p-4">
                  <div
                  ...
                  <div className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                    <div className="flex min-h-[80px]">
                      {/* Cue area */}
                      <div className="w-1/3 bg-blue-50 dark:bg-blue-950 p-2 border-r border-gray-200 dark:border-gray-600">
                        <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Cue</p>
            ...
            <div className="p-6">
              ...
              <div className="border-2 border-gray-300 dark:border-gray-600 rounded-xl overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row min-h-[300px]">
                  {/* Cue Column */}
                  <div className="sm:w-1/3 bg-blue-50 dark:bg-blue-950 border-b sm:border-b-0 sm:border-r border-gray-300 dark:border-gray-600">
                    <div className="p-3 border-b border-gray-300 dark:border-gray-600 bg-blue-100 dark:bg-blue-900">
                      <h4 className="font-semibold text-blue-800 dark:text-blue-200 text-sm">{t('cueColumn') || '단서/질문'}</h4>
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">{t('cueDescription') || '키워드, 질문, 핵심 개념'}</p>
                    </div>
                    <textarea
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="border-2 border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row min-h-[300px]">
                  {/* Cue Column */}
                  <div className="sm:w-1/3 bg-blue-50 dark:bg-blue-950 border-b sm:border-b-0 sm:border-r border-gray-200 dark:border-gray-600">
                    <div className="p-3 border-b border-gray-200 dark:border-gray-600 bg-blue-100 dark:bg-blue-900">
                      <h4 className="font-semibold text-blue-800 dark:text-blue-200 text-sm">{t('cueColumn') || '단서/질문'}</h4>
                    </div>
                    <div className="p-4">
