    ...
    for (let day = 1; day <= totalDays; day++) {
      ...
      days.push(
        <div
          ...
          className={`h-12 sm:h-24 border border-gray-100 p-1 sm:p-2 cursor-pointer transition-colors hover:bg-gray-50 ${
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{selectedDateSessions.length} {t('session')}(s)</p>
                </div>
                <button
              ...
              {selectedDateSessions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">{t('noSessionsScheduled')}</p>
                  <button
                    onClick={openAddModal}
