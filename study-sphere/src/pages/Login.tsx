...
export default function Login() {
  ...
  const { setIsLoggedIn, setUser, t } = useApp()
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const userData = {
        ...
        avatarType: user.photoURL ? 'image' : 'letter',
        uid: user.uid,
      }
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('verificationEmailSent')}</h2>
            <p className="text-gray-600 mb-6">
              {t('verificationEmailSentDesc')} <strong>{formData.email}</strong>
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">StudyPlan</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
