                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-medium text-gray-900 mb-1">{t('changePassword')}</h3>
                      <p className="text-sm text-gray-500 mb-3">{t('changePasswordDesc')}</p>
                      <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors text-sm font-medium">
                        {t('changePassword')}
                      </button>
                    </div>
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-medium text-gray-900 mb-1">{t('twoFactorAuth')}</h3>
                      <p className="text-sm text-gray-500 mb-3">{t('twoFactorAuthDesc')}</p>
